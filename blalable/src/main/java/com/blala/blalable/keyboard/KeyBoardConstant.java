...
public class KeyBoardConstant {
    ...
    public static byte[] dealWidthBData(int imgCount){
        ...
        byte[] bt2 = new byte[]{0x14, 0x03, 0x00, 0x01, 0x06, 0x00, 0x00, (byte) imgCount, 0x00, 0x00, 0x01, 0x40, 0x00, (byte) 0xAC, 0x00, 0x00, 0x00, 0x00 ,0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ,0x00, 0x00, 0x00, 0x00};
